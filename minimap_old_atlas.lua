...
local _ = nil; -- placeholder for unused atlas values

-- Extend the existing atlasinfo instead of overwriting it
local minimap_atlas = {
...
-- Merge minimap atlas entries into the main atlas table
for key, value in pairs(minimap_atlas) do
	addon.atlasinfo[key] = value;
end